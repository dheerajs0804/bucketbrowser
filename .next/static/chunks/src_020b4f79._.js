...
"[project]/src/lib/cognito.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
// Replace these values with the ones from your new Cognito User Pool
__turbopack_context__.s({
...
const COGNITO_USER_POOL_ID = "eu-west-1_MB8bf6SKS";
const COGNITO_CLIENT_ID = "1jrmt0nvub0mhltt34bb59rvg4";
const COGNITO_IDENTITY_POOL_ID = "eu-west-1:98657588-a247-4c64-b4b0-5712dec4810a";
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function AuthProvider({ children }) {
    ...
    const oidcConfig = {
        authority: `https://cognito-idp.${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cognito$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AWS_REGION"]}.amazonaws.com/${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cognito$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COGNITO_USER_POOL_ID"]}`,
        client_id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cognito$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COGNITO_CLIENT_ID"],
...
_s(AuthProvider, "uR0IUXDv5K01+KUENYAPgEk6PGQ=", false, function() {
    return [
...
//# sourceMappingURL=src_020b4f79._.js.map